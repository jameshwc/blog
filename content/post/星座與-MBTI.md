...
我相信星座這句話的更精確說法應該是：「我認可星座對我個性的描述。」
...
回歸到 MBTI 本身，它只是一項幫助認識自己和別人的工具，亦不用過於神化，因為其本身也有許多不足，像是它假設人會在四個面向偏向某一端或另外一端，但每個面向其實都是光譜，更多人是分佈在光譜的中間稍微偏某一邊，以內外向這個維度當例子的話，還有第三種介在內向與外向之間的性格－－[綜向（Ambivert）](https://introvertdear.com/ambivert-meaning-definition/)，這種人格就有可能會覺得 MBTI 的描述沒有說得很正確。[^3] 
...
[^2]: 這句話又要得罪討厭星座的人了XD
[^3]: 不過大部分的 MBTI 測驗結果都會提供四個面向的分佈情況，如果發現某個維度很靠中間的話，也可以參考另外一個字母的組合，例如測出來是在內、外向的維度很中間的 INFP，不妨也去參考 ENFP 的描述。